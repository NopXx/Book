              ...
              >
                {isActive === false ? (
                  <div className="justify-start p-1 m-2">
                    <p className="py-1">ชื่อ : {sData.s_fname}</p>
                    <p className="py-1">นามสกุล : {sData.s_lname}</p>
                    <p className="py-1">Username : {sData.s_user}</p>
                    <p className="py-1">เบอร์โทรศัพท์ : {sData.s_tel}</p>
                    <p className="py-1">
                      ตำแหน่ง :{" "}
                      {sData.position === 1 ? "ผู้ดูแลระบบ" : "พนักงาน"}
                    </p>
                  </div>
                ) : (
                  <>
